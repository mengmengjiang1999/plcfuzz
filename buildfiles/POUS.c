void PROGRAM0_init__(PROGRAM0 *data__, BOOL retain) {
  ...
  __INIT_LOCATED(BOOL,__QX0_0,data__->LED2,retain)
...
void PROGRAM0_body__(PROGRAM0 *data__) {
  ...
  __SET_LOCATED(data__->,LED2,,(__GET_LOCATED(data__->LED,) && __GET_LOCATED(data__->PB1,)));
  __SET_LOCATED(data__->,LED,,!(__GET_LOCATED(data__->LED2,)));
