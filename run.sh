...
g++ -std=gnu++11  ./src/*.cpp ./build/*.o -o openplc -I ./lib -I ./plclogic/ -pthread -fpermissive `pkg-config --cflags --libs libmodbus` -lasiodnp3 -lasiopal -lopendnp3 -lopenpal -w $ETHERCAT_INC
