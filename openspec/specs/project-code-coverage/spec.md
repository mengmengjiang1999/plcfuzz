...
The repository SHALL maintain a machine-readable coverage scope that whitelists maintained C++ and Python sources and excludes MatIEC, generated PLC sources, generated binding code, archived material, and external measurement tooling.
